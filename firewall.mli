...
val ipv4_from_netvm : Resolver.t -> Router.t -> Nat_packet.t -> unit Lwt.t
(** Handle a packet from the outside world (this module will validate the source IP). *)

val ipv4_from_client : Resolver.t -> Router.t -> src:Fw_utils.client_link -> Nat_packet.t -> unit Lwt.t
